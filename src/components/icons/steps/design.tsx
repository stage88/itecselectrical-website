...
function DesignStepIcon() {
  return (
    <span className='u-icon u-icon-circle u-palette-1-base u-spacing-21 u-text-white u-icon-2'>
      <svg
        ...
        x='0'
        y='0'
        enableBackground='new 0 0 54.953 54.953'
        version='1.1'
